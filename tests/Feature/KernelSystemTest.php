...
it('registers bindings when container is enabled', function () {
    $interface = 'Tests\\Feature\\Support\\KernelSampleContract';
    $service = 'Tests\\Feature\\Support\\KernelSampleService';
...
it('hydrates container bindings from boot cache payload shape', function () {
    $payload = [
        'bindings' => [
            Tests\Feature\Support\KernelSampleContract::class => Tests\Feature\Support\KernelSampleService::class,
        ],
        'controllers' => [],
        'singletons' => [],
    ];
