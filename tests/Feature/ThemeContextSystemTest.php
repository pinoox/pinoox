...
{
    themeContextDeleteDirectory(dirname(__DIR__, 2) . '/apps/' . $package);
    themeContextDeleteDirectory(dirname(__DIR__, 2) . '/pinker/apps/' . $package);
}

function appThemeContextDir(): string
{
    return dirname(__DIR__, 2) . '/apps/com_test_theme_ctx';
}
