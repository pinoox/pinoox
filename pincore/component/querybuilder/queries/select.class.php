...
use pinoox\component\querybuilderModel;
use pinoox\component\querybuilder\{Exception, Query, Utilities};
...
class Select extends Common implements \Countable
{
     ...
     * @throws Exception
     *
     * @return mixed false if there is no row
     */
    public function exists()
    {
        return gettype($this->fetch()) != "boolean";
    }
