<?php if ($trace['file']) { ?>
<details class="px-trace-frame trace-line <?= $lineClass ?? ''; ?>"<?= ('expanded' === ($style ?? '')) ? ' open' : ''; ?><?= !empty($isOrigin) ? ' id="px-trace-origin"' : ''; ?>>
    <summary class="trace-line-header break-long-words<?= !empty($isOrigin) ? ' trace-line-origin-header' : ''; ?>">
...
<?php } else { ?>
<div class="trace-line-header break-long-words px-trace-frame px-trace-frame--plain <?= $lineClass ?? ''; ?>">
    <div class="px-trace-line-content">
        <?php if ($trace['function']) { ?>
            <span class="trace-class"><?= $this->abbrClass($trace['class']); ?></span><?php if ($trace['type']) { ?><span class="trace-type"><?= $trace['type']; ?></span><?php } ?><span class="trace-method"><?= $trace['function']; ?></span>
        <?php } else { ?>
            <span class="trace-muted">Frame without file context</span>
        <?php } ?>
    </div>
</div>
<?php } ?>
