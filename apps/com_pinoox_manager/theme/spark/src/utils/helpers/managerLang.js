...
const MESSAGES = {
    fa: {
        ...
        are_you_sure_delete_app: 'آیا از حذف اپلیکیشن مطمئن هستید؟',
        cannot_delete_system_app: 'امکان حذف اپلیکیشن سیستمی وجود ندارد.',
        app_uninstall_lead: 'این اپلیکیشن به‌طور کامل از سرور حذف می‌شود',
        app_uninstall_hint: 'فایل‌ها، مایگریشن‌ها، مسیرها و کش pinker پاک می‌شوند. این عملیات برگشت‌پذیر نیست.',
        app_uninstall_confirm: 'حذف اپلیکیشن',
    ...
    en: {
        ...
        cannot_delete_system_app: 'System apps cannot be uninstalled.',
        app_uninstall_lead: 'This app will be fully removed from the server',
        app_uninstall_hint: 'Files, migrations, routes, and pinker cache will be removed. This cannot be undone.',
        app_uninstall_confirm: 'Uninstall app',
