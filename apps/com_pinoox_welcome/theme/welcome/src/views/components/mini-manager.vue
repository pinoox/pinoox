<template>
    ...
    >
        <div class="mini-manager__chrome">
            <div class="mini-manager__traffic" aria-hidden="true">
                <span class="mini-manager__traffic-dot mini-manager__traffic-dot--close"></span>
                <span class="mini-manager__traffic-dot mini-manager__traffic-dot--minimize"></span>
                <span class="mini-manager__traffic-dot mini-manager__traffic-dot--maximize"></span>
            </div>

            <span class="mini-manager__chrome-title">Pinoox Manager</span>

            <div class="mini-manager__url-bar" :aria-label="$t('miniManagerUrlHint')">
                <span class="mini-manager__url-lock" aria-hidden="true">
                    <svg viewBox="0 0 16 16" fill="none"><rect x="3.5" y="7" width="9" height="6.5" rx="1.5" stroke="currentColor" stroke-width="1.2"/><path d="M5.5 7V5a2.5 2.5 0 0 1 5 0v2" stroke="currentColor" stroke-width="1.2" stroke-linecap="round"/></svg>
                </span>
        ...
        <div class="mini-manager__workspace">
            <aside class="mini-manager__sidebar" :aria-label="$t('miniManagerDock')">
                ...
                >
                    ...
                    <span class="mini-manager__nav-label">{{ $t(view.titleKey) }}</span>
                </button>
            </aside>
                    ...
                    <div :key="activeView" class="mini-manager__panel">
                        <div v-if="activeView === 'dashboard'" class="mini-manager__dashboard">
                            ...
                            <div class="mini-manager__hero-card" aria-hidden="true">
                                ...
                                <div class="mini-manager__hero-app">
                                    <span class="mini-manager__hero-app-icon">
                                        <MarketAppIcon :name="activeApp.icon" />
                                    </span>
                                    <span class="mini-manager__hero-app-name">{{ $t(activeApp.labelKey) }}</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div v-else-if="activeView === 'apps'" class="mini-manager__launcher">
                            <div
                                ...
                                :style="{ '--tile-color': tile.color, animationDelay: `${index * 0.08}s` }"
                            >
...
const stats = [
    ...
    { key: 'uptime', value: '99.9%', labelKey: 'miniManagerStatUptime' },
];
