 ...
 * - pinker/state: always (shared hosting relies on this; no .env required)

 * - .env: only for local development (optional elsewhere)
...

{
...

    {
        ...
        $file->applyToRuntime($env);

        SystemConfig::clearCache();



        if (self::shouldWriteEnvFile($file, $mode) && !$file->setMany($env)) {
    ...
    public static function shouldWriteEnvFile(EnvFile $file, ?string $mode = null): bool
